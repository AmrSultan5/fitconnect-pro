...
import { ClipboardList, Plus, FileText, Users } from "lucide-react";
...
export default function WorkoutPlansPage() {
  const { user } = useAuth();
  const [plans, setPlans] = useState<WorkoutPlanWithClient[]>([]);
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Create and manage workout plans for your clients</p>
          </div>
          <Button asChild>
            <Link to="/coach/workouts/new">
            ...
            {activePlans.length > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Currently assigned workout plans</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            {inactivePlans.length > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Complete history of workout plans</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
