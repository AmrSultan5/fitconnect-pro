    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card><CardContent className="pt-6"><Link to="/client/workout" className="flex items-center gap-4"><div className="rounded-lg bg-primary/10 p-3"><ClipboardList className="h-5 w-5 text-primary" /></div><div><p className="text-sm text-muted-foreground">Workout</p><p className="text-sm font-medium text-primary">View →</p></div></Link></CardContent></Card>
          <Card><CardContent className="pt-6"><Link to="/client/diet" className="flex items-center gap-4"><div className="rounded-lg bg-accent/10 p-3"><Utensils className="h-5 w-5 text-accent" /></div><div><p className="text-sm text-muted-foreground">Diet</p><p className="text-sm font-medium text-primary">View →</p></div></Link></CardContent></Card>
        </div>
